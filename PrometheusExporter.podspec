Pod::Spec.new do |spec|
  spec.name                      = 'PrometheusExporter'
  spec.summary                   = 'PrometheusExporter'
  spec.version                   = '1.4.0'
  ...
  spec.source_files              = ['Sources/Exporters/Prometheus/**/*.swift']

  spec.dependency 'NIO', '~> 2.0.0'
  spec.dependency 'NIOHTTP1', '~> 2.0.0'
end
