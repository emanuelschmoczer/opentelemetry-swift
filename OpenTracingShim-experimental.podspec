Pod::Spec.new do |spec|
  spec.name                      = 'OpenTracingShim-experimental'
  spec.summary                   = 'OpenTracingShim-experimental'
  spec.version                   = '1.4.0'
  ...
  spec.source_files              = ['Sources/Importers/OpenTracingShim/**/*.swift']

  spec.dependency 'Opentracing', '~> 0.5.2'
end
